...
class Text:
    ...
    def input(self):
        ...
        for i in range(len(key)):
            if time.time() - self.timee > 0.5 and key[i]:
...
class Market:
    ...
    def start(self):
        ...
        prices = {'armor': 100, 'boot': 70, 'glock': 50, 'helmet': 100, 'short': 75, 'm1': 200}
        ...
        while True:
            ...
            for i in cells:
                ...
                if i.press(poss, press) and int(self.moneys)>=int(i.price) and i.text not in self.bought:
