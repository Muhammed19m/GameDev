...
class Reg:
    ...
    def start(self, window, ip_s, port_s, name, money, coins):
        exit_b = Button(
            (self.w / 2 - 150, self.h / 2 + 200, 300, 100),
            (255, 153, 51),
            "Сохранить",
            48,
            width_text=10,
        ...
        get_data = Button(
            (self.w / 2 - 150, self.h / 2 + 100, 300, 90),
            (255, 153, 51),
            "Получить данные",
            30,
            width_text=10,
        ...
        my_json_for_server = (
            f'"name": "{name}", ' f'"money": "{money}",' f'"coins": "{coins}"'
        )
...
class ConfigGame:
    def __init__(self, h, w):
        ...
        self.count_player = Text(
            (500, 40), "2", (self.w / 2 - 200, self.h / 2 - 150), 32
        )
    ...
    def start(self, window):
        exit_b = Button(
            (self.w / 2 - 100, self.h / 2 + 200, 200, 100),
            (255, 153, 51),
            "Готово",
            48,
            width_text=15,
